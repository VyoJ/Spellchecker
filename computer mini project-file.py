...
ft = tkFont.Font(family='Times',size=10)
GLabel_124["font"] = ft
GLabel_124["bg"] = "#211C60"
GLabel_124["fg"] = "#8E9B80"
GLabel_124["justify"] = "center"
GLabel_124["text"] = "Browse files to spellcheck"
GLabel_124.place(x=0,y=80,width=600,height=55)
...
v=tk.Scrollbar(label_sugg, orient='horizontal')  #the scrollbar isnt working and im not quite sure why
v.pack(side=tk.BOTTOM, fill='x')
