...
win = tk.Tk()
win.config(background='#808080')    # AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA REMEMBERRRR THISSSSSSSSSSSSSSSSSSS
...
scroll=tk.Scrollbar(win, orient='horizontal')  #the scrollbar isnt working and im not quite sure why
scroll.pack(side=tk.BOTTOM, fill='x')

#scroll.config(command=label_sugg.xview)

t = tk.Text(win, width = 15, height = 15, wrap = tk.NONE, xscrollcommand = scroll.set)
t.place(x=60,y=330,width=479,height=56)
